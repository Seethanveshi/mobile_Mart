                                    ...
                                    <div className='DetailsandDeliveryDate'>
                                        <div>
                                            ...
                                            <div className='Rating'>
                                                ...
                                                <span style={{display:'flex' , alignItems:'center'}}><svg className='starImage' xmlns="http://www.w3.org/2000/svg" width="20" height="1"><path fill="#FFF" d="M6.5 9.439l-3.674 2.23.94-4.26-3.21-2.883 4.254-.404L6.5.112l1.69 4.01 4.254.404-3.21 2.882.94 4.26z"/></svg></span>
                                            </div>
